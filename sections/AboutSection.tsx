...
import sandipThapa from "../public/Node+EVM.webp";
        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
              ...
              <div className="relative w-72">
                ...
                <div className="profile-picture overflow-hidden md:overflow-visible rounded-md md:shadow-2xl">
                  <Image
                    ...
                    height={1790}
                    priority
                    alt="Sandip Thapa profile picture"
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              With over 2 years of comprehensive experience in web application
              and blockchain development, I have honed my skills in both blockchain and server-side
...
const educationInfo = [
  {
    ...
    subTitle: "Tribhuwan University- IOE, Purwanchal Campus | 2017 ~ 2022",
    list: [
      "Studied computer Engineering, software development",
  ...
  //   id: 3,
  //   title: "IELTS",
  //   subTitle: "British Council Nepal | 2022",
