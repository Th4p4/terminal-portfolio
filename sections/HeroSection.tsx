...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        PASSIONATE PROGRAMMER FREELANCER BLOCKCHAIN/NODE ENGINEER
      </span>
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="overflow-hidden">
          <span className="text-animation text-2xl md:text-3xl lg:text-5xl block md:my-3 text-marrsgreen dark:text-carrigreen font-medium">
            A Blockchain/Node.Js Developer
          </span>
        </div>
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a Blockchain/Node.Js Developer with a passion for delivering
            exceptional results.
          </p>
          <p>
            With my expertise in EVM, Zilliqa on Blockchain, and NodeJS, and Express on the backend, I bring a unique
