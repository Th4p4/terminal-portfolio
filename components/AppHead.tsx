...
const AppHead: React.FC<Props> = ({
  ...
  let author = "Sandip Thapa";
  let description =
    "Articles about programming, coding, technologies, software engineering, Blockchain, EVM, Decentralizatiion and my personal projects and my experiences.";
  let siteName = "Sandip Thapa's Portfolio";
  let type = "article";
